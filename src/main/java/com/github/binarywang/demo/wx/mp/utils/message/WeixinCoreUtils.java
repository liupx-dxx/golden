...
public class WeixinCoreUtils{

    private static Logger logger = LoggerFactory.getLogger(WeixinCoreUtils.class);
    ...
    @Autowired
    private WinXinRespUtil winXinRespUtil;
    ...
    public String weixinMessageHandelCoreService(HttpServletRequest request,
        ...
        try {
            ...
            if (msgType.equals(weixinMessageUtil.REQ_MESSAGE_TYPE_TEXT)){
                ...
                respContent = winXinRespUtil.resp(content);
            ...
            // 事件推送(当用户主动点击菜单，或者扫面二维码等事件)
                ...
                // 上报地理位置
                if (eventType.equals(weixinMessageUtil.EVENT_TYPE_LOCATION)) {
